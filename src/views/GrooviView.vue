<template>
  ...
  >
    <div class="backdrop-opacity-50 bg-light/80">
      <div class="container py-24 mx-auto px-4">
        <div class="">
          <div class="container grid grid-cols-1 text-center">
            <h2
    ...
    <div class="">
      ...
      <div class="lg:w-full mx-auto flex flex-wrap justify-center items-center">
        <div class="w-full lg:py-6 mt-6 lg:mt-0">
          <GalleryVideoLightbox :gallery="GalleryVideos" />
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="container py-24 mx-auto px-4">
    <div class="">
      ...
      <div class="lg:w-full mx-auto flex flex-wrap justify-center items-center">
        <div class="w-full lg:py-6 mt-6 lg:mt-0">
          <GalleryImageLightbox :gallery="GalleryImgs" />
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="mx-auto bg-white rounded-md py-16 mb-32">
      ...
      >
        <div class="flex items-center">
          ...
          <a
            href="https://www.instagram.com/groovioficial/"
            target="_blank"
            class="text-gray-300 mr-3 hover:bg-primary hover:border-primary flex h-16 w-16 items-center justify-center hover:text-white"
          >
            <svg
          ...
          <a
            href="https://www.youtube.com/user/GrooVIchannel"
            target="_blank"
...
import imgUrl3 from '@/assets/images/sitesys/groovi/fotos-groovi-03.jpg'
import imgUrl4 from '@/assets/images/sitesys/groovi/fotos-groovi-04.jpg'
import imgUrl5 from '@/assets/images/sitesys/groovi/fotos-groovi-05.jpg'
import imgUrl6 from '@/assets/images/sitesys/groovi/fotos-groovi-06.jpg'
import imgUrl7 from '@/assets/images/sitesys/groovi/fotos-groovi-07.jpg'
import imgUrl8 from '@/assets/images/sitesys/groovi/fotos-groovi-08.jpg'
import imgUrl9 from '@/assets/images/sitesys/groovi/fotos-groovi-09.jpg'
import imgUrl10 from '@/assets/images/sitesys/groovi/fotos-groovi-10.jpg'
import imgUrl11 from '@/assets/images/sitesys/groovi/fotos-groovi-11.jpg'
import imgUrl12 from '@/assets/images/sitesys/groovi/fotos-groovi-12.jpg'
import bgUrl3 from '@/assets/images/sitesys/bg/bg-04.jpg'

import presskit from '@/assets/images/sitesys/groovi/press-kit.pdf'
...
useHead({
  ...
  meta: [
    {
      name: 'description',
      content: 'My description About Page',
    },
    ...
    },
    {
      ...
      content: 'SiteSyS WPA - My description About Page',
    },
    {
      property: 'og:image',
