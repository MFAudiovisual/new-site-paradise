<template>
  <SliderHero size="78vh" :sliders="sliderImg" />
  <!-- Release -->
  <div
    class="bg-[url('/src/assets/images/sitesys/gallery/image-01.jpg')] bg-no-repeat bg-cover"
  >
    ...
    <div class="mx-auto bg-white dark:bg-extra-dark/80 rounded-md py-16 mb-32">
      ...
      >
        <div class="flex items-center">
          <a
            href="https://www.facebook.com/ParadiseEntretenimentoBR"
            target="_blank"
          ...
          <a
            href="https://www.instagram.com/ParadiseEntretenimentoBR/"
            target="_blank"
            class="text-gray-300 mr-3 hover:bg-primary hover:border-primary flex h-16 w-16 items-center justify-center hover:text-white"
          >
            <svg
          ...
          <a
            href="https://www.youtube.com/@paradiseentretenimento3423"
            target="_blank"
...
import heroUrl1 from '@/assets/images/sitesys/gallery/image-01.jpg'
